...
public class EnemyGarbageController : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        { 
            ...
            // Lanzar la basura hacia la posici�n aleatoria
    ...
    {
        // Elegir una posici�n aleatoria del array de puntos de destino
        int randomIndex;
        do
        {
    ...
    {
        // Crear una instancia del prefab del objeto que lanzar�s
        ...
        // Calcular la velocidad inicial en funci�n de la direcci�n y la fuerza de lanzamiento
